...
\begin{figure*}
	\begin{center}
		\subfigure[Pressure and Temperature]{\includegraphics[height=2.9in]{DCR_Pressure-Temperature}}
		\subfigure[Zenith Angle and Pressure]{\includegraphics[height=2.9in]{DCR_ZA-Pressure}}
		\subfigure[Zenith Angle and Temperature]{\includegraphics[height=2.9in]{DCR_ZA-Temperature}}
